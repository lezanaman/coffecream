<%-- 
    Document   : about
    Created on : 26/10/2017, 09:01:22 AM
    Author     : bryan
--%>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="bg-faded p-4 my-4">
        <hr class="divider">
        <h2 class="text-center text-lg text-uppercase my-0">Quienes  
          <strong>Somos</strong>
        </h2>
        <hr class="divider">
        <div class="row">
          ...
          <div class="col-lg-6">
              <h2>Vision</h2>
            <p>Ser tu restaurante chapin preferido .</p>
            <h2>Mision</h2>
            <p>Compartimos nuestra pasion por la comida chapina para alegrar y llenar de orgullo mas corazones chapines</p>
          </div>
        </div>
      </div>
    </div>
